...
/* harmony import */ var _vendor_phone_mask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/phone-mask */ "./js/vendor/phone-mask.js");
/* harmony import */ var _modules_init_nav_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-nav-header */ "./js/modules/init-nav-header.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_nav_header__WEBPACK_IMPORTED_MODULE_3__["initNavHeader"])();
  ...
  window.addEventListener('load', function () {
    Object(_vendor_phone_mask__WEBPACK_IMPORTED_MODULE_2__["initPhoneMask"])();
...
var SELECTION_START = 4;
var SELECTION_RANGE = 3;
  ...
  if (!e.target.selectionStart) {
    setTimeout(function () {
      ...
      if (e.target.value.startsWith('+8')) {
        e.target.value = "+7 ".concat(e.target.value.slice(SELECTION_RANGE));
        return;
      }
      e.target.value = '';
    });
...
var getMatrixLimitationsRegEx = function getMatrixLimitationsRegEx(matrix) {
  switch (matrix) {
    case 'digit':
      return /[^\d]/g;
    case 'name':
      return /[^а-яёА-ЯЁa-zA-Z-]]/g;
    case 'letters':
      return /[^а-яёА-ЯЁa-zA-Z]/g;
    case 'letters-and-digit':
      return /[^а-яёА-ЯЁa-zA-Z\d]/g;
    case 'cyrillic':
      return /[^а-яёА-ЯЁ]/g;
    case 'latin':
      return /[^a-zA-Z]/g;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initNavHeader", function() { return initNavHeader; });
var initNavHeader = function initNavHeader() {
  ...
  document.addEventListener('click', function (evt) {
    var click = evt.composedPath().includes(headerNav);
    if (!click) {
      onToggleMenu();
    }
  });
...
var replacePhoneValue = function replacePhoneValue(el) {
  var matrix = "".concat(COUNTRY_CODE, "__________");
  var def = matrix.replace(/\D/g, '');
  var i = 0;
